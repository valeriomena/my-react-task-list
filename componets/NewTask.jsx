...
function NewTask(props) {
  const { key,id, email, doneTask, name, descript, date, hour,handleDeleteClick ,handleSaveClick, handleCheckboxChange} = props;
  ...
  return (
      <div className="TaskStyle">
        <div className='tasklabels'>  
          <input className={`box ${showCard ? 'hidden' : ''}`} type="checkbox" checked={checked} onChange={(e) => { handleCheckboxChange(e); setChecked(e.target.checked); }} />
        </div>
        <b>
          <div className='tasklabels'>
            <label
